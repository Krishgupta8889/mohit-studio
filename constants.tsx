...
export const PORTFOLIO_ITEMS: PortfolioItem[] = [
  ...
  { id: 7, url: 'https://res.cloudinary.com/dbmikomtn/image/upload/v1766744951/WhatsApp_Image_2025-12-25_at_8.45.56_PM_ccxfrr.jpg', category: 'Weddings', title: 'nayi shuruaat' },
  { id: 8, url: 'https://res.cloudinary.com/dbmikomtn/image/upload/v1766745115/WhatsApp_Image_2025-12-25_at_11.50.20_PM_majuru.jpg', category: 'Portraits', title: 'forevers' },
];
